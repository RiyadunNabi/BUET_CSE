...
class ShapeCollection
{
    ...
    {
        //rctngl[count_r++]=r;
        rctngl[count_r].setLength(r.getLength());
        rctngl[count_r].setWidth(r.getWidth());
        rctngl[count_r].setColor(r.getColor());
        count_r++;
    }
    void addTriangle(Triangle &t)
    {
        //trngl[count_t++]=t;
        trngl[count_t].seta(t.geta());
        trngl[count_t].setb(t.getb());
        trngl[count_t].setc(t.getc());
        trngl[count_t].setColor(t.getColor());
        count_t++;
    }
    void addCircle(Circle &c)
    {
        //crcl[count_c++]=c;
        crcl[count_c].setradious(c.getRadius());
        crcl[count_c].setColor(c.getColor());
        count_c++;
    }
    int getRectCount()
    {
