public class Main {
    public static void main(String[] args) {
        ...
        reg.registerStudent(s1.id, cse101.code);
        reg.registerStudent(s2.id, cse101.code);
        reg.registerStudent(s3.id, cse101.code); // will fail; course full, suggest waitlist
        reg.waitlistStudent(s3.id, cse101.code);

        // s1.enrollIn(cse201);
        reg.registerStudent(s1.id, cse201.code);
