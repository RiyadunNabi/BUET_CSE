public class TestScenarios {
    public static void main(String[] args) {
        ...
        System.out.println("CSE101 initial: status=" + cse101.getStatus() + " enrolled=" + cse101.getEnrolledCount() + " cap=" + cse101.getCapacity());
        // alice.enrollIn(cse101);
        // bob.enrollIn(cse101);
        reg.registerStudent(alice.id, cse101.code);
        reg.registerStudent(bob.id, cse101.code);
        System.out.println("CSE101 after 2 enrollments: status=" + cse101.getStatus() + "\n");
        ...
        reg.registerStudent(charlie.id, cse101.code);
        reg.waitlistStudent(charlie.id, cse101.code);
        reg.waitlistStudent(diana.id, cse101.code);
        reg.waitlistStudent(evan.id, cse101.code);
        ...
        System.out.println("Before drop: status=" + cse101.getStatus());
        // alice.dropCourse(cse101);
        reg.unregisterStudent(alice.id,cse101.code);
        System.out.println("After drop: status=" + cse101.getStatus() + " (Charlie promoted from waitlist)");
        cse101.printRoster();
        cse101.printWaitlist();
        System.out.println();
        ...
        reg.unregisterStudent(bob.id,cse101.code);
        System.out.println("After Bob drops: status=" + cse101.getStatus() + " (Diana promoted)");
        cse101.printRoster();
        System.out.println();
        ...
        System.out.println("CSE499 before: " + cse499.getStatus());
        cse499.setStatusAdmin(CourseStatus.OPEN);
        System.out.println("CSE499 after: " + cse499.getStatus());
        // evan.enrollIn(cse499);
        reg.registerStudent(evan.id,cse499.code);
        System.out.println();

        // Test 6: OPEN -> CLOSED
        System.out.println("--- Test 6: Admin OPEN -> CLOSED ---");
        System.out.println("CSE310 before: " + cse310.getStatus());
        cse310.setStatusAdmin(CourseStatus.CLOSED);
        System.out.println("CSE310 after: " + cse310.getStatus());
        // alice.enrollIn(cse310);
        reg.registerStudent(alice.id,cse310.code);
        System.out.println();
        ...
        System.out.println("CSE400 before: " + cse400.getStatus());
        cse400.setStatusAdmin(CourseStatus.DRAFT);
        System.out.println("CSE400 after: " + cse400.getStatus() + " (no longer visible to students)");
        System.out.println();
        ...
        reg.registerStudent(alice.id,cse150.code);
        System.out.println("CSE150 before: " + cse150.getStatus());
        cse150.setStatusAdmin(CourseStatus.CLOSED);
        System.out.println("CSE150 after: " + cse150.getStatus());
        System.out.println();
        ...
        // bob.enrollIn(cse250);
        reg.registerStudent(alice.id,cse250.code);
        reg.registerStudent(bob.id,cse250.code);
        System.out.println("CSE250 status: " + cse250.getStatus() + " (enrolled=" + cse250.getEnrolledCount() + ", cap=" + cse250.getCapacity() + ")");
        // charlie.waitlistFor(cse250);
        // diana.waitlistFor(cse250);
        // evan.waitlistFor(cse250);
        // frank.waitlistFor(cse250);
        reg.waitlistStudent(charlie.id,cse250.code );
        reg.waitlistStudent(diana.id,cse250.code);
        reg.waitlistStudent(evan.id, cse250.code);
        reg.waitlistStudent(frank.id, cse250.code);
        ...
        System.out.println("After capacity increase, status became: " + cse250.getStatus());
        ...
        reg.registerStudent(diana.id, cse260.code);
        reg.registerStudent(evan.id, cse260.code);
        System.out.println("CSE260 status: " + cse260.getStatus());
        // alice.waitlistFor(cse260);
        // bob.waitlistFor(cse260);
        // charlie.waitlistFor(cse260);
        reg.waitlistStudent(alice.id, cse260.code);
        reg.waitlistStudent(bob.id, cse260.code);
        reg.waitlistStudent(charlie.id, cse260.code);
        ...
        System.out.println("CSE500 before: " + cse500.getStatus());
        cse500.setStatusAdmin(CourseStatus.CLOSED);
        System.out.println("CSE500 after: " + cse500.getStatus());
        System.out.println();
        ...
        System.out.println("CSE220 before: " + cse220.getStatus());
        cse220.setStatusAdmin(CourseStatus.OPEN);
        System.out.println("CSE220 after: " + cse220.getStatus());
        // alice.enrollIn(cse220);
        reg.registerStudent(alice.id, cse220.code);
        System.out.println();
        ...
        System.out.println("CSE201 before: enrolled=" + cse201.getEnrolledCount() + " cap=" + cse201.getCapacity() + " status=" + cse201.getStatus());
        cse201.setCapacity(3);
        System.out.println("CSE201 after capacity increase: status=" + cse201.getStatus());
        // bob.enrollIn(cse201);
        reg.registerStudent(bob.id, cse201.code);
        System.out.println();

        // Test 14: Capacity decrease
        System.out.println("--- Test 14: Capacity decrease (more enrolled than capacity) ---");
        System.out.println("CSE220 before: enrolled=" + cse220.getEnrolledCount() + " cap=" + cse220.getCapacity() + " status=" + cse220.getStatus());
        cse220.setCapacity(1);
        System.out.println("CSE220 after capacity decrease: status=" + cse220.getStatus() + " (over capacity)");
        System.out.println();
        ...
        System.out.println("CSE101 before: " + cse101.getStatus());
        cse101.setStatusAdmin(CourseStatus.DRAFT);
        System.out.println("CSE101 after: " + cse101.getStatus() + " (course reinstated for planning)");
        System.out.println();
        ...
        reg.registerStudent(bob.id, cse700.code);
        reg.waitlistStudent(charlie.id, cse700.code);
        reg.waitlistStudent(diana.id, cse700.code);
        ...
        reg.registerStudent(alice.id, cse900.code);
        System.out.println("CSE900 status: " + cse900.getStatus());
        ...
        System.out.println("CSE499 status: " + cse499.getStatus());
        ...
        reg.registerStudent(diana.id, cse220.code);
        ...
        reg.registerStudent(bob.id, cse1000.code);
        reg.waitlistStudent(charlie.id, cse1000.code);
        ...
        reg.unregisterStudent(bob.id, cse1000.code);
        charlie.printSchedule();
