...
public class CommandHandler {
     ...
     */
    public void handleExportTxt(String outputPath, String type) {
        try {
            ...
            writer.writeReport(outputPath, mainRepository, type);
        } catch (IOException e) {
     ...
     * @param outputPath the output file path
     */
    public void handleExportHtml(String outputPath, String type) {
        try {
